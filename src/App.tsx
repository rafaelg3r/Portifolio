...
function App() {
  return (
    <div>
      ...
      <div className="px-28 flex flex-col gap-16 hero-bg">
        <Header />
        <div className="flex justify-center items-center mt-30">
          <ProjectCard height="h-[600px]" width="min-w-[914px]" padTop="pt-20">
            <div className="absolute flex justify-between items-center px-3 -top-px left-0 right-0 h-10 rounded-t-[10px] bg-linear-to-r  from-white-100 via-white-500 to-white-100">
      ...
      <div className="bg-stone-925 w-full h-full z-20 py-10 relative flex flex-col justify-center items-center">
        <About>
          <h1>Rafael</h1>
        </About>
        <div className="flex flex-col gap-20 justify-center items-center py-10 ">
          <ProjectCard
          ...
          <ProjectCard
            link="https://classmindsr.vercel.app/"
            height="h-[667px]"
            width="min-w-[914px]"
            padTop="pt-9"
